      ...
      <div className="flex flex-1 flex-col gap-2 p-5">
        ...
        {noWhatsApp && (
          <a
            ...
            className="mt-auto inline-flex w-fit items-center gap-2 rounded-full bg-hijau-700 px-4 py-2 text-sm font-medium text-krem-50 transition-colors hover:bg-hijau-800"
          >
