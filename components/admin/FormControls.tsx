...
export const btnPrimer =
  "inline-flex items-center justify-center gap-2 rounded-lg bg-hijau-800 px-5 py-2.5 text-sm font-semibold text-krem-50 transition-colors hover:bg-hijau-900 active:bg-hijau-950 disabled:cursor-not-allowed disabled:opacity-60";

export const btnNetral =
  "inline-flex items-center justify-center gap-2 rounded-lg border border-stone-300 bg-white px-5 py-2.5 text-sm font-semibold text-stone-700 transition-colors hover:bg-stone-50 active:bg-stone-100";

export const btnBahaya =
  "inline-flex items-center justify-center gap-2 rounded-lg bg-red-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-red-700 active:bg-red-800 disabled:cursor-not-allowed disabled:opacity-60";
